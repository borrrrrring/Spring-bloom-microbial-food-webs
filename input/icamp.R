...
# 1.数据准备####
# 存放输入文件的文件夹
wd="C:/Users/lenovo/Desktop/icamp/input"
...
bin.size.limit = 48  # 对于真实数据，通常根据系统发育信号测试使用适当的数字或尝试一些设置然后选择合理的随机性水平。我们的经验是12、24或48。但对于这个太小的示例数据集，必须使用5
